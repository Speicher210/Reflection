...
class ReflectionFunctionTest extends TestCase {
    ...
    public function testGetParametersWithParametersReturnArray() {
        ...
        $actual = $reflectionFunction->getParameters();
        $expectedParameter1 = new ReflectionParameter('Wingu\OctopusCore\Reflection\Tests\Unit\Fixtures\testFunction1', 'param1');
        $expectedParameter2 = new ReflectionParameter('Wingu\OctopusCore\Reflection\Tests\Unit\Fixtures\testFunction1', 'param2');
