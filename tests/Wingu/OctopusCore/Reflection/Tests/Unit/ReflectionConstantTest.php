...
class ReflectionConstantTest extends TestCase {
    ...
    public function testReflectionConstantConstructWithNameDeclaringClassAndValue() {
        $reflectionConstant = new ReflectionConstant('Wingu\OctopusCore\Reflection\Tests\Unit\Fixtures\ImplementorClass1', 'CONSTANT1');
    ...
    public function testExportWithoutPrintingReturnTheExportString() {
        $actual = ReflectionConstant::export('\Wingu\OctopusCore\Reflection\Tests\Unit\Fixtures\ImplementorClass2', 'CONSTANT1', true);
    ...
    public function testGetDocCommentWithValidCommentReturnTheDocComment() {
        $reflectionConstant = new ReflectionConstant('Wingu\OctopusCore\Reflection\Tests\Unit\Fixtures\ReflectionConstantDocComment', 'CONSTANT2');
        $actual = $reflectionConstant->getDocComment();
        $expected = '/**
     * This is *a comment* {};
     */';
