...
class ReflectionClassMethodsTest extends TestCase
{
    ...
    public function testGetMethod()
    {
        ...
        $this->assertInstanceOf('\Wingu\OctopusCore\Reflection\ReflectionMethod',
            $reflection->getMethod('getMethodPublic'));
        $this->assertInstanceOf('\Wingu\OctopusCore\Reflection\ReflectionMethod',
            $reflection->getMethod('getMethodProtected'));
        $this->assertInstanceOf('\Wingu\OctopusCore\Reflection\ReflectionMethod',
            $reflection->getMethod('getMethodPrivate'));
    }
    ...
    public function testGetMethodsCorrectMethod()
    {
        ...
        $this->assertSame('Wingu\OctopusCore\Reflection\Tests\Unit\Fixtures\GetMethodClass',
    ...
    public function testGetOwnMethodsWithOwnMethodsReturnsArray()
    {
        ...
        $expected = array(
            new ReflectionMethod('\Wingu\OctopusCore\Reflection\Tests\Unit\Fixtures\ImplementorClass2', "method2")
        );
